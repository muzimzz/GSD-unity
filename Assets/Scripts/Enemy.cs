...
{   
    ...
    private EnemySpawner enemySpawner; //적의 삭제를 본인이 하지 않고 EnemySpawn에 알려서 삭제\
    ...
    {   
        ...
        while(true){
            // 적의 현재 위치와 목표위치의 거리가 0.02 * movement2D.MoveSpeed 보다 작을 떄 if 조건문 실행
            // Tip. movement2D.MoveSpeed를 곱해주느 이유는 속도가 빠르면 한 프레임에 0.02보다 크게 움직이기 떄문에
